//CALCULOS TOTALES Y SUBTOTALES (Metodos Prototipos)        
   ...
   comprobante.prototype.calcular = function(parent){
    ...
    comprobante.prototype.calcularMontoNeto = function(padre){

  var importepagomonto = $(padre).children().children().children('#importe_pagoMonto').val();

  //console.log(importepagomonto)

  if ($('#retencion').is(':checked')) {
  /* para la retencion*/
  var porcentaje_de_retencion = $('#porcentaje_de_retencion').val();
  var total_retencion = parseFloat(importepagomonto * (porcentaje_de_retencion/100)).toFixed(2);

  var importe_pagoMonto_Neto =  parseFloat(importepagomonto - total_retencion).toFixed(2);
  console.log(importe_pagoMonto);
  $(padre).children().children().children('#importe_pagamontoneto').val(importe_pagoMonto_Neto);
  }
...
if ($('#detraccion').is(':checked')) {
  ...
  var total_detraccion = parseFloat( importepagomonto * (porcentaje_de_detraccion/100)).toFixed(2);
  var importe_pagoMonto_Neto = parseFloat(importepagomonto - total_detraccion).toFixed(2);
   console.log(importe_pagoMonto);
 ...
 //METODOS IMPLEMENTADOS    
    ...
    /*calculo para el valor neto en caso de retencion y detraccion */
    $(document).on('keyup',"#importe_pagoMonto",function(e){
        var parent = $(this).parents().parents().parents().get(0);        
       // console.log(parent);    
        cmp.calcularMontoNeto(parent);
    });
