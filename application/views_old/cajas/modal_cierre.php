...
<?PHP
	...
	if($selecReporteCaja['Transferencia']){
		$totalTransferencia = $selecReporteCaja['Transferencia'];
	}	
	if($selecReporteCaja['Yape']){
		$totalYape = $selecReporteCaja['Yape'];
	}	
		...
		<form id="formCierreCaja">
			<input type="hidden" name="caja_id" id="caja_id" value="<?= $caja->id?>">			
				...
				<div class="row">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="totalTransferencia" id="totalTransferencia" value="<?= $totalTransferencia?>" readonly>					
					</div>
				</div>	
				<div class="row">
					<div class="col-md-3">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" name="totalYape" id="totalYape" value="<?= $totalYape?>" readonly>					
					</div>
				</div>	
				<div class="row">					
						<h3>Total</h3>					
...
<script type="text/javascript">
	...
	function calcular(){
		...
		var montoTotal =  parseFloat(totalContado)+parseFloat(totalDeposito)+parseFloat(totalCheque)+parseFloat(totalTarjeta)+parseFloat(totalCupon)+parseFloat(totalCredito)+parseFloat(totalTransferencia)+parseFloat(totalYape);
