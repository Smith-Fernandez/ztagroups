...
<head>
    ...
    body{
        ...
        text-align:center;
        margin:0;font-family: Verdana, monospace
    }  
    ...
    *,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}  
    ...
    body{
         ...
         font-family:"open sans","Helvetica Neue",Helvetica,Arial,sans-serif;background-color:#2f4050;
         font-size:13px;
         color:#676a6c;
         overflow-x:hidden
         /*codigo para establecer el margen de impresion*/
 ...
 <div style="padding:50px 220px;">
     ...
     <table width="100%" style="border-bottom: 1px dashed #000;">
         <tr style="border-bottom: 1px dashed #000;">
             ...
             <td style="padding-bottom: 5px;padding-top: 10px;">DESCRIPCIÓNsss</td>
