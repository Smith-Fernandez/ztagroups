<html>
    <head>
        <style>
          ...
          /*codigo para que al momento de imprimir deje un margen hacia bajo
               cuando se le puso el margen no respetaba los hr de color blanco
          */
           hr
           {
...
<?php 
 ...
 ?>
        ...
        <!--<span id="height-container">-->
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="datos_totales">
                    <div style="word-wrap: break-word;line-height: 0.8em">
                               <!-- el nl2br para que respete el salto de linea-->     
                                 <span><?php echo nl2br($comprobante->notas)?></span>
                            </div>
        ...
        <div>
            ...
            <b style="font-size:4px"> Crédito a <?php echo $comprobante->ndias;?> dias / 
                Fecha: <?php echo (new DateTime($value->fecha_cuota))->format("d/m/Y");?> 
                Monto: <?php echo $value->monto;?> </b><?php } ?>
            <!--<?php if ($value->fecha_cuota !="") { ?>
