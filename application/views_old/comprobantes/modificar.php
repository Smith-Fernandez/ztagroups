...
<div class="input-group" style="padding-bottom: 2rem;">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <input id="guardar" type="submit" class="btn btn-primary btn-lg btn-block" value="Actualizar Comprobante de Pago" style="background: #1ABC9C;border:0;display: none;"/>
                <button type="button" id="guardar2"  class="btn btn-primary btn-lg btn-block" style="background: #1ABC9C;border:0;" data-toggle='modal' data-target='#myModalPagoMonto' data-keyboard='false' data-backdrop='static'>Actualizar Comprobante de Pago</button>
            </div>
        </div>                    
    </div> 
</form>
...
<script type="text/javascript"> 
    ...
    $("#guardar_old").click(function(e){
        e.preventDefault();
        $.ajax({
            method:'post',
            url:"<?PHP echo base_url()?>index.php/comprobantes/modificar_comprobante/<?PHP echo $comprobante['comprobante_id'];?>",
