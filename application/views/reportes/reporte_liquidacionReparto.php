...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		function buscarReporte(){
			$.ajax({
				url: '<?= base_url()?>index.php/reportes/reporte_liquidacionReparto_bs',
				dataType: 'HTML',
				method: 'POST',
        ...
        var url ='<?PHP echo base_url() ?>index.php/reportes/exportarLiquidacion?'+datos+'&vendedorText='+vendedorText+'&transportistaText='+transportistaText;
