  ...
  <input type="hidden" value="<?php echo $producto->prod_tipo?>" name="prod_tipo" id="prod_tipo">
        ...
        <div class="panel panel-default">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="medida"> PRODUCTO TIPO </label>
              <select class="form-control" id="tipo_insumo" name="tipo_insumo" <?php echo ($producto->prod_id==1)?"readonly":"";?>>
                <option value="">Seleccione</option>
                <?php foreach ($tipo_insumos as $valor):?>
                    <option value="<?php echo $valor->id;?>" <?php if($valor->id == $producto->prod_tipo_insumo):?> selected <?php endif?>  > <?php echo $valor->tipo_insumo;?></option>  
                <?php endforeach ?>                            
              </select>
            </div>
          </div>    
