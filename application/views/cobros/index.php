...
$(document).ready(function(){
	...
	$(document).on("click",".btn_regCobro",function(){
		...
		$("#myModal").load("<?= base_url()?>index.php/cobros/modal_crear/",{comprobante_id: comprobante_id,cliente_id: cliente_id,vendedor_id: vendedor_id,saldo: saldo,tipoComprobante:tipoComprobante,serNum:serNum,totalCredito:totalCredito});
	});
