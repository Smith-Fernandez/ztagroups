                        ...
                        <div class="form">
                            <div class="row">
                               <div class="col-sm-4" >
                                ...
                                <div class="col-sm-2">
                                    <label>Numero</label>
                                    <input type="text" style="width: 100px;" name="numero" id="numero" class="form-control" value="<?php echo $guia->guia_numero?>" readonly>
                                </div>
                                <div class="col-sm-4">
                                    <label>N° Orden</label>
                                    <input type="text" name="orden" id="orden" class="form-control" value="<?php echo $guia->orden?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                        ...
                        <div class="form">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="hidden" name="destinatario_razon_social2" id="destinatario_razon_social2" class="form-control" value="<?php echo $guia->destinatario_razon_social?>">                                     
                                </div>
                            </div>
                             <div class="row">
                                  <div class="col-sm-12">
                                    <label>Direccion Fiscal</label>
                                    <input type="text" name="llegada_direccion2" id="llegada_direccion2" class="form-control" value="<?php echo $guia->destinatario_direccion_fiscal?>">                                    
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                      ...
                                      <!--cambio 08-10-2021-->
                                      <input type="text" id="ubigeo_partida" name="ubigeo_partida"  list="lista_ubigeo_partida" class="form-control input-sm" value="180101 - MOQUEGUA|MARISCAL NIETO|DEPARTAMENTO MOQUEGUA|" readonly>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <!--cambio 08-10-2021-->
                                    <input type="text" name="partida_direccion" id="partida_direccion" class="form-control" value="Asoc. E. López Albujar Mz D - Lt 8 II etapa San Antonio - Moquegua" readonly>
                                </div>                                                        
                            </div>
                            <div class="row">                                
                                <div class="col-sm-6">                                    
                                ...
                                <div class="col-sm-6">
                                   ...
                                   <!-- <input type="hidden" name="llegada_direccion2" id="llegada_direccion2" class="form-control" value="<?php echo $guia->destinatario_direccion_fiscal?>"> -->
                                </div>                            
                            </div>
                        </div>
                    </div>
  ...
  $(function(){    
    $('#destinatario_razon_social').autocomplete({
            ...
            select : function (event,ui){
                ...
                $("#destinatario_razon_social2").val(ui.item.razon_social);
                $("#llegada_direccion").val(ui.item.domicilio1);
                $("#llegada_direccion2").val(ui.item.domicilio1);               
            }
    });     
  });
    //FUNCIONES FECHAS   
        ...
        if(listaProductos.length>0)
        {
            ...
            $.each(listaProductos, function(index, value){
                ...
                if(value.prod_codigo!=null){
                    html += '<td colspan="2" class="col-3"><input type="text" name="codigo[]" class="form-control" id="codigo" value="'+value.prod_codigo+'" readonly></td>';
                }else{
                    html += '<td colspan="2" class="col-3"><input type="text" name="codigo[]" class="form-control" id="codigo" value="none" readonly></td>';
                }
    ...
    function consulta_sunat(ruc_cliente,tipo){        
        switch(tipo) {
          case 1:
            ...
            razon_social2 = "destinatario_razon_social2";
            ...
            $.getJSON('http://mundosoftperu.com/sunat/sunat/consulta.php',{nruc:num})
             .done(function(json){
                 ...
                 if(json.result.RUC.length!=undefined){
                    ...
                    $("#llegada_direccion2").val(json.result.Direccion);
                    $("#"+razon_social2).val(json.result.RazonSocial);
                    $("#"+ruc_sunat).val(num);
                    toast("success", 1500, 'Datos encontrados con exito');
                 }else{
