                            ...
                            <div class="row" id="valida">
                                <div class="col-xs-12 col-md-12 col-lg-12">
                                    <table id="tabla" class="table table-striped" <?php if(count($nota->detalles)==0):?> style="display:none" <?php endif?> >
                                        <thead>
                                            <tr>
                                                <th class="col-sm-3" colspan="2" >Descripcion</th>  
...
<script type="text/javascript">            
    ...
    $(function(){       
        var fila = '<tr class="cont-item">'; 
                fila += '<td colspan="2"><div id="data_kit"><label class="col-sm-1 control-label glyphicon glyphicon-triangle-top"></label></div>'+
                        '<div class="col-sm-11"><input type="text" class="form-control descripcion-item" rows="2" id="descripcion" name="descripcion[]"><div id="data_item"><input type="hidden" name="item_id[]" id="item_id"></div><input type="hidden" name="productoKit[]" class="productoKit"></div></td>';
    ...
    $(document).on("click",".btn_agregar_presentacion",function(){ 
        ...
        //e.preventDefault();               
        //var idProducto = $(this).data('id');        
        //$("#myModal").load('<?PHP echo base_url()?>index.php/productos/agregarPresentacion/'+idProducto,{});
