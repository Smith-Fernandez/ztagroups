    ...
    $('body').delegate('.descripcion-item', 'keydown', function() {
        $('.descripcion-item').autocomplete({
            ...
            select : function (event,ui){                
                ...
                var data_kit  = (ui.item.prod_tipo_insumo == 2) ? '<label class="col-sm-1 control-label glyphicon glyphicon-triangle-top btn_agregar_presentacion" data-id="'+ui.item.id+'" data-toggle="modal" data-target="#myModal"></label>': '<label class="col-sm-1 control-label glyphicon glyphicon-triangle-top"></label>';
    ...
    $(function(){       
        var fila = '<tr class="cont-item">'; 
                fila += '<td colspan="2"><div id="data_kit"><label class="col-sm-1 control-label glyphicon glyphicon-triangle-top"></label></div>'+
                        '<div class="col-sm-11"><input type="text" class="form-control descripcion-item" rows="2" id="descripcion" name="descripcion[]"><div id="data_item"><input type="hidden" name="item_id[]" id="item_id"></div></div></td>';
