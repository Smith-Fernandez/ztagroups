                    ...
                    <div class="form-group" style="padding-top:20px;">                        
                       ...
                       <!-- <div class="col-xs-2 col-md-2 col-lg-2">
                        ...
                        <div class="col-xs-6 col-md-4 col-lg-3">
                                ...
                                <input type="text" name="condicion_pago" id="condicion_pago" class="form-control" value="<?= $proforma->prof_condicion_pago?>">
                        </div>  
                        <div class="col-xs-6 col-md-4 col-lg-3">
                                <label>Plazo Entrega</label>
                                <input type="text" name="plazo_entrega" id="plazo_entrega" class="form-control" value="<?= $proforma->prof_plazo_entrega?>">
                        </div>                                       
                    </div>
    ...
    <div class="row" style="padding-top:20px;">               
        <div class="col-xs-12 col-md-8 col-lg-8">                                                                         
            <div class="panel panel-info" id="panel_otros">
                ...
                <div class="panel-body">
                    <textarea style="width: 100%" name="observaciones" id="observaciones" rows="3" cols="100"><?php echo $proforma->prof_doc_observacion?></textarea>
                </div>
            </div>            
        </div>        
...
<script type="text/javascript">        
    ...
    /*buscar producto*/
        ...
        $('.descripcion-item').autocomplete({
            ...
            select : function (event,ui){                
                ...
                _item.find('#medida').val(ui.item.prod_medida_id);
    ...
    function agregar_fila_sin_stock(){     
        var fila = '<tr class="cont-item">';                            
                ...
                fila += '<td style="border:0;" colspan="">'+
        ...
        $.ajax({
            ...
            success:function(response){
                if(response.status == STATUS_OK)
                {
                    ...
                    setTimeout(function(){
                        location.href='<?PHP echo base_url()?>index.php/proformas/index';    
                    },500);
