...
<head>
    ...
    *,:after,:before{-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box}  
    ...
    body{line-height:1.42857143;font-family:"open sans","Helvetica Neue",Helvetica,Arial,sans-serif;background-color:#2f4050;font-size:13px;color:#0f0f0f;overflow-x:hidden}  
        ...
        <table width="100%" height="220px" border="0" aling="center" cellpadding="0" cellspacing="0">-->
                <tbody>
                    <tr>
                        ...
                        <!--<span><img src="<?PHP echo FCPATH;?>images/<?php echo $empresa->foto;?>" height="160" width="280" style="text-align:center;" border="0"></span><br>
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                       <!-- <td width="60%" align="left"><strong>Dirección:</strong>  <?php echo $guia->llegada_direccion?></td>-->
                        <td width="60%" align="left"><strong>Dirección:</strong>  <?php echo $guia->destinatario_direccion_fiscal?></td>
                        <td width="40%" align="left"><strong>N° de orden:</strong>  <?php echo $guia->orden?></td>
                    </tr>
                    </tbody></table>
            </div><br>
            <div class="tabla_borde">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td width="60%" align="left"><strong>Ubigeo. Partida:</strong>   <?php echo $guia->ubigeo_partida_nom?></td>
                        <td width="40%" align="left"><strong>Ubigeo. Llegada: </strong>  <?php echo $guia->ubigeo_llegada_nom?></td>
                    </tr>
                    </tbody></table>
            </div><br>
            ...
            <div class="tabla_borde">
              ...
              <div class="tabla_borde">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    <tbody>
                    <tr>
                        <td colspan="3"><strong>CONFORMIDAD</strong></td>
                    </tr>
                    <tr class="border_top">
                    ...
                    <tr class="border_top">
                        <td width="60%" align="center"><strong>ZTA GROUP E.I.R.L.</strong></td>
                        <td width="40%" align="center"><strong>RECIBI CONFORME</strong></td>
