...
<head>
    ...
    body{<?= $anulado?>;background-repeat:no-repeat;background-position:center top;font-family:"open sans","Helvetica Neue",Helvetica,Arial,sans-serif;background-color:#2f4050;font-size:13px;color:#020000;overflow-x:hidden;}  
    .table>tbody>tr>td{border-top:1px solid #e7eaec;padding:5px}  
    .white-bg{background-color:#fff}        
    .table-cabecera {line-height:1.3}
    .producto_cabecera{ background-color: #17202A;color: #FFF; text-align: center;font-weight: bold;}
...
<table width="100%" border="0">
    <tbody><tr>
        <td>
            <table width="100%" height="220px" border="0" aling="center" cellpadding="0" cellspacing="0" class="table-cabecera">
                <tbody>
                    ...
                    <td width="54%"  align="left">                        
                      <img src="<?PHP FCPATH;?>images/<?php echo $empresa->foto;?>" height="200" width="280" style="text-align:center;" ><br>
            ...
            <br><br><br><p class="datos_anulacion" style="color: red;"><?php echo $anulacion->fecha_anulacion?></p>
                    </br><br><br>
            <label style="color:red;">USUARIO:</label><br><br><br>
            <p class="datos_anulacion" style="color: red;"><?php echo $anulacion->nombre ?></p>
                    <br>
            <label style="color:red;"> MOTIVO:</label><br><br><br>
            <p class="datos_anulacion" style="color:red;"><?php echo $anulacion->motivo_anulacion ?></p>
                                </td>
                               <?php } ?> 
                  <?php if ($comprobante->anulado == 1) { ?>
                                    ...
                                    <table width="100%" border="0" class="pie_de_pagina">
                                     ...
                                     <?php if($comprobante->tipo_documento_id != 0){?>      
                                        ...
                                        <tr>
                                            ...
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_anticipos,2)?></span></td>
                                        </tr>
                                        <?php endif?>
                                        <?php if($comprobante->descuento_global > 0):?>
                                        <tr >
                                            <td><strong>Descuento Global:</strong></td>
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->descuento_global,2)?></span></td>
                                        </tr>
                                        <?php endif?>                                                       
                                        <tr >
                                            <td><strong>Op. Gravadas:</strong></td>
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_gravada,2)?></span></td>
                                        </tr>                            
                                        <tr >
                                            <td><strong>Op. Inafectas:</strong></td>
                                            <td ><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_inafecta,2)?></span></td>
                                        </tr>
                                        <tr >
                                            <td><strong>Op. Exoneradas:</strong></td>
                                            <td ><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_exonerada,2)?></span></td>
                                        </tr>                            
                                        <?php if($comprobante->total_igv > 0):?>
                                        <tr >
                                            <td><strong>IGV:</strong></td>
                                            <td ><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_igv,2)?></span></td>
                                        </tr>
                                        <?php endif?>
                                        <?php if($comprobante->total_icbper > 0):?>
                                        <tr>
                                            <td><strong>ICBPER:</strong></td>
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_icbper,2)?></span></td>
                                        </tr>
                                        <?php endif?>                            
                                        <?php if($comprobante->total_otros_cargos > 0):?>
                                        <tr>
                                            <td><strong>Otros Cargos:</strong></td>
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_otros_cargos,2)?></span></td>
                                        </tr>
                                        <?php endif?>
                                    <?php } ?>
                                        <tr class="border_bottom monto_a_pagar">
                                            <td><strong>Total a Pagar:</strong></td>
                                            <td><span><?php echo $comprobante->simbolo?> <?php echo number_format($comprobante->total_a_pagar,2)?></span></td>
                                        </tr>   
                ...
                <tr> 
                    ...
                    <td>                        
                        <div>  
                        <b>MEDIO PAGO</b>&nbsp;&nbsp;&nbsp;<b>MONTO</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>OP/OBSER.</b>&nbsp;&nbsp;&nbsp;&nbsp;<b>FECHA</b><br><br>
                         <?PHP foreach($pagoMonto as $value){?>                                        
                                                <table style="text-align: left;" border="0" class="pie_de_pagina">
                                                    <tr>
                                                        <td width="50"><b><?= $value->tipo_pago?></b></td>
                                                        <td width="40"><b><?= number_format($value->monto,2)?></b></td>
                                                        <td width="25"><b><?= $value->observaciones?></b></td>
                                                        <td width="25"><b><?php
                                                         if ($value->fecha_cuota !="") {
                                                             echo (new DateTime($value->fecha_cuota))->format("d/m/Y");
                                                         }
                                                          ?></b></td>                                              
                                                    </tr>
                                                </table>
