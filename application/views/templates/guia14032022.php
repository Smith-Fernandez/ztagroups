            ...
            <div class="tabla_borde">
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td width="60%" align="left"><strong>Ubigeo. Partida:</strong>   <?php echo $guia->ubigeo_partida?></td>
                        <td width="40%" align="left"><strong>Ubigeo. Llegada: </strong>  <?php echo $guia->ubigeo_llegada?></td>
                    </tr>
                    </tbody></table>
            </div><br>
