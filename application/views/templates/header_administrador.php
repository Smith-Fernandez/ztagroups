...
<span class="label label-primary"><?= "MODO ".MODO;?></span>
<!--<div id="contenido">    
    <div id="book_renew_div">
    <div class="menu_header" ><div style="height:50px; width:auto; font-weight:bold; padding:4px 10px 0 10px; border-radius:5px; color:#FFF; font:1.4em; float:left; ">Renovar libro / s de miembros</div><div class="close" onclick="javascript:toggleSlideBox('contenido');">X</div></div>-->