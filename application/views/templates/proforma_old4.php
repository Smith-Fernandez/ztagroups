...
<head>
   ...
   html{
    font-family:sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;font-size:10px;-webkit-tap-highlight-color:transparent;size: auto; /* auto is the initial value */ /* this affects the margin in the printer settings */ margin: 4mm 14mm 10mm 14mm;}    
...
<hr>
            ...
            <div class="tabla_borde">
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <?PHP if($proforma->prof_mostrar_imagen == 2 && $item->prod_imagen != ''){?>                            
                                <img class="prod_imagen" src="<?= 'images/productos/'.$item->prod_imagen;?>" width="150" height="150" >
