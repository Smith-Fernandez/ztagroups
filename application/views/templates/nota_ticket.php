...
<?php 
 ...
 ?>
        ...
        <img src="images/logo01.jpeg" height="80" width="100%" style="text-align:center;" border="0" class="logo">
        <span id="height-container">
            <p class ="datos_titulo1 cabecera">
                <!--<span class="datos_cabecera_bold"><?php echo $empresa->empresa?></span><br>-->
                <span class="datos_cabecera_bold">MULTICAR</span><br>
                <!--<span class="datos_cabecera_bold">RUC : <?php echo $empresa->ruc?></span><br>-->
                <span class="datos_cabecera_bold">RUC : 10443962889</span><br>
                <!--<span class="datos_cabecera"><?php echo $empresa->domicilio_fiscal?></span>-->
                <span class="datos_cabecera">Dirección: Urb. E. López Albujar Mz D - Lt 8 II etapa <br>San Antonio - Moquegua</span><br>
                -------------------------------------------------------------------------
            ...
            <p class="datos_cliente"> CLIENTE :
                <?php echo $cliente->razon_social?> <?php echo $comprobante->nombres?><br><?php if($nota->tipo_cliente_id==1):?><?php else:?><?php endif?><?php echo "DNI/RUC:  ". $cliente->ruc?><br>
