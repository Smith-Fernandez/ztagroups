                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                      ...
                                      <?php } ?>                                      
                                        ...
                                        <span style="font-family:Tahoma, Geneva, sans-serif; font-size:18px" text-align="center">E L E C T R Ó N I C A</span>
            ...
            <div class="tabla_borde" >
                ...
                <table width="100%" border="0" cellpadding="5" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td width="60%" align="left"><strong>Placa: </strong> <?php echo strtoupper($comprobante->placa)?></td>
                    ...
                    <?php if ($configuracion->condicion_venta): ?>     
                        ...
                        <?php if($comprobante->condicion_venta!=''): ?>                       
                            ...
                            <td width="60%" align="left"><strong>Condición de Venta: </strong><?php echo $comprobante->condicion_venta?></td>
                ...
                <table width="100%" border="0" cellpadding="7" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center" class="bold" style="border-left: 2px solid #aaa;">Descripción</td>
                                    ...
                                    <?PHP foreach($pagoMonto as $value){?>
                                        ...
                                        <table border="" class="" >
                                            ...
                                            <tr>
                                                ...
                                                <td width="10"><b><?= $value->tipo_pago?></b></td>
                                                <?php if ($value->fecha_cuota !="")
                                                    { ?>
                                                      <td width="10"><b><?= "Cuota 0".$i?></b></td>
                                                    <?php  }
                                                    else{ ?>
                                            ...
                                            <!--CAMBIO PARA MOSTAR FECHA DE PAGO-->    
                                                <td width="60"><b><?php if ($value->fecha_cuota !="") {
                                                             echo 'Fecha Pago '.(new DateTime($value->fecha_cuota))->format("d/m/Y");
                                                         }
                                                ?></b></td>           
                                                <?php if ($value->fecha_cuota !="") { ?>
                                                    <td>
                                                        <?php $date1 = new DateTime($value->fecha_de_emision);
                                                         ...
                                                         ?>
                                                      <b>Forma de Pago Crédito a <?php echo $comprobante->ndias;?> dias</b>  
                                                    </td>
                                               <?php }  ?>                                     
...
<!-- codigo para mostrat retencion o detraccion -->

 <?php if ($comprobante->retencion == 1 ): ?>

  <div class="tabla_borde" style="float: left;">
                <table border="0" class="table-pagmonto" >
                        <tr>
                    
                        <td style="text-align:center;border-bottom:1px solid #aaa;"><B>INFORMACIÓN DEL CRÉDITO</B></td>
                        </tr>
                        <tr>
                       <td><B style="font-size: 10px;">MONTO NETO PENDIENTE DE PAGO:  <?php echo   $comprobante->simbolo?> <?php 
                               //echo $comprobante->total_a_pagar
    ...
    <div class="tabla_borde" style="float: left;">
                                 <table border="0" class="table-pagmonto">
                                     <tr>
                                         <td colspan="3" style="border-bottom: 1px solid #aaa; text-align: center;"><b>INFORMACION DE LA RETENCION</b></td>
                                     </tr>
                                     <tr>
                                         <td style="border-bottom: 1px solid #aaa;border-right:1px solid #aaa;" > <b>Base Imponible</b></td>
                                         <td style="border-bottom: 1px solid #aaa;border-right:1px solid #aaa;"><b>% de la retencion</b></td>
                                         <td style="border-bottom: 1px solid #aaa;"><b>Monto</b> </td>
                                     </tr>
                                     <tr>
                                         <td style="border-right:1px solid #aaa;text-align: center;"><?php echo $comprobante->total_a_pagar ?></td>
                                         <td style="border-right:1px solid #aaa;text-align: center;"><?php echo $comprobante->porcentaje_de_retencion ?> %</td>
                                         <td  style="text-align: center;"><?php echo number_format($comprobante->total_retencion,2) ?></td> 
                                     </tr>
                                 </table>    
</div>
<hr><hr>
...
<?php if ($comprobante->detraccion == 1 ): ?>
    ...
    <div class="tabla_borde" style="float: left;">
                                 <table border="0" class="table-pagmonto">
                                     <tr>
                                         <td colspan="3" style="border-bottom: 1px solid #aaa;text-align: center;"><b>INFORMACION DE LA DETRACCION</b></td>
                                     </tr>
                                     <tr>
                                         <td style="border-bottom: 1px solid #aaa;border-right:1px solid #aaa;" > <b>Base Imponible</b></td>
                                         <td style="border-bottom: 1px solid #aaa;border-right:1px solid #aaa;"><b>% de la detraccion</b></td>
                                         <td style="border-bottom: 1px solid #aaa;"><b>Monto</b> </td>
                                     </tr>
                                     <tr>
                                         <td style="border-right:1px solid #aaa;text-align: center;"><?php echo $comprobante->total_a_pagar ?></td>
                                         <td style="border-right:1px solid #aaa;text-align: center;"><?php echo $comprobante->porcentaje_de_detraccion ?> %</td>
                                         <td style="text-align: center;"><?php echo number_format($comprobante->total_detraccion,2) ?></td> 
                                     </tr>
                                 </table>    
</div> 
<hr><hr>
