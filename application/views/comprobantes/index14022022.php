    ...
    $(document).ready(function () {
        ...
        $(document).on('ready',function() {
            ...
            $('#exportarExcel').click(function(){
                ...
                var url = '<?PHP echo base_url() ?>index.php/comprobantes/exportarExcel/' + cliente_id + '/' +  fecha_de_emision_inicio + '/' + fecha_de_emision_final + '/' + serie + '/' + numero + '/' + empresa_id + '/'+ numero_pedido+ '/' + orden_compra + '/' + numero_guia;
