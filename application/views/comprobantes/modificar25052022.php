...
<form id="formComprobante" class="form-horizontal" role="form" action="<?PHP echo base_url()?>/index.php/comprobantes/modificar_comprobante/<?PHP echo $comprobante['comprobante_id'];?>" method="post" autocomplete="off">
    <input type="hidden" name="comprobante_id" id="comprobante_id" value="<?= $comprobante['comprobante_id']?>">
    ...
    <div class="row">        
        <div class="col-md-12">
            <div style="text-align: center"><h3>EDITAR COMPROBANTE DE PAGO</h3></div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">                     
                    <div class="form-group" style="padding-top:20px;">            
                        <div class="col-xs-12 col-md-12 form-inline col-lg-12" >                                                
                        ...
                        <div class="col-md-4 col-lg-4 input_cliente">
                            ...
                            <input type="text" class="form-control" id="cliente" value="<?PHP echo $comprobante['cli_razon_social'];?>">    
                                <input type="hidden" name="ruc_sunat" id="ruc_sunat">
                                <input type="hidden" name="razon_sunat" id="razon_sunat">
                        </div>
                        <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2 input_busqueda">
                            <?php if($comprobante['tipo_documento_id'] == 1){?><br>
                            ...
                            <?php } else{ ?>
                              <button type="button" id="nuevo_cliente" class="btn btn-primary btn-sm btn_buscar" data-toggle='modal' data-target='#myModalNuevoCliente'>Nuevo Cliente</button>
                            <?php }?>    
                        </div> 

                        <div class="col-xs-12 col-md-6 col-lg-6">
                           <label class="control-label">Dirección:</label>
                            <input type="text" class="form-control" name="direccion" id="direccion" value="<?PHP echo $comprobante['direccion_cliente'];?>">
                        </div>                        
                        <div class="col-xs-6 col-md-2 col-lg-2">            
                            <label class="control-label">Serie:</label>
                            <!--<input type="text" class="form-control" name="serie" id="serie" value="" maxlength="4" required="">-->
                            <select class="form-control" name="serie" id="serie" readonly>
                        ...
                        <div class="col-xs-6 col-md-2 col-lg-2">
                            ...
                            <input type="text" class="form-control" name="numero" id="numero" value="<?PHP echo $comprobante['numero'];?>" maxlength="9" required="" readonly>
                        </div>
...
<input type="hidden" value="[]" id="adelanto_items" name="adelanto_items">
                        ...
                        <div class="col-xs-12 col-md-2 col-lg-2">
                            ...
                            <input type= "text" class="form-control" id="placa" name="placa" value="<?= $comprobante['cli_placa'];?>">
                        </div>
                        <!-- orden compra -->
                            ...
                            <table id="tabla" class="table">
                                ...
                                <tr class="cont-item">                                                                                                    
                                    ...
                                    <td colspan="2" class="col-sm-4">
                                        <input class="form-control descripcion-item" rows="2" id="descripcion" name="descripcion[]" value="<?PHP echo $val['descripcion'];?>" readonly><div id="data_item"></div><input type="hidden" name="item_id[]" id="item_id" value="<?php echo $val['producto_id']?>"></div></td>                                        
                                    <td style="display: none;"><input type="text" class="form-control" readonly id="medida" name="medida[]" value="<?php echo $val['medida_nombre']?>"></td>
                                     <?PHP }else{ ?>
                                    <td class="col-sm-3"><textarea class="form-control" rows="2" id="descripcion" name="descripcion[]" required="" readonly><?PHP echo $val['descripcion'];?></textarea><div id="data_prod"><input type="hidden" name="item_id[]" id="item_id" value="<?php echo $val['producto_id']?>"></div> </td>
                                     <td class="col-sm-1">
    ...
    <div class="row" style="padding-top:20px;">               
        <div class="col-md-8 col-lg-8">
            ...
            <div class="panel panel-body">
                ...
                <label class=" control-label" style="margin-left:-50px">Detraccion:</label>
                    <div class="material-switch pull-left">
                        <input id="detraccion" name="detraccion" type="checkbox" />
                <label for="detraccion" class="label-primary"></label>
                    </div>
                </div>
                 <div class="col-xs-3 col-md-3 col-lg-3">
                  <label class="control-label">Tipo Detraccion:</label>        
                  <select class="form-control" name="tipo_detraccion" id="tipo_detraccion">
                  <?PHP foreach ($tipo_detracciones as $value) { ?>                          
                      <option value = "<?PHP echo $value->id;?>" <?php echo ($value->id== $comprobante['tipo_detraccion_id'])?"selected":"";?>><?PHP echo $value->codigo.' '.$value->tipo_detraccion?> </option>
                  <?PHP }?>
                  </select>    
                </div>                
                <div class="col-xs-3 col-md-3 col-lg-3">
                    <label class="control-label">N° de Cuenta</label>
                    <input type="text" class="form-control" name="numero_cuenta_detraccion" id="numero_cuenta_detraccion" value="0601-026724">
                </div>                
                <div class="col-xs-2 col-md-2 col-lg-2">
                    <label class="control-label">% de Detraccion:</label>
                    <input type="text" class="form-control" name="porcentaje_de_detraccion" id="porcentaje_de_detraccion" value="<?php echo $comprobante["porcentaje_de_detraccion"];?>">
                </div>                
                <div class="col-xs-2 col-md-2 col-lg-2">
                    <label class="control-label">Total de Detraccion:</label>
                    <input type="text" class="form-control" name="total_detraccion" id="total_detraccion" value='<?php echo $comprobante["total_detraccion"]; ?>'>
            ...
            <!-- MUESTRA DETRACCION , FACTURA O BOLETA -->
            <div class="panel panel-info" id="panelRetencion" style="display: none;">
              <div class="panel-heading">
                    <div class="panel-title">RETENCION</div>
                </div>
            <div class="panel panel-body">
                <div class="col-xs-1 col-md-1 col-lg-1">
                <label class=" control-label" style="margin-left:-50px">Retencion:</label>
                    <div class="material-switch pull-left">
                        <input id="retencion" name="retencion" type="checkbox" />
                <label for="retencion" class="label-primary"></label>
                    </div>
                </div>
                <div class="col-xs-1 col-md-1 col-lg-1"></div>                                              
                <div class="col-xs-3 col-md-3 col-lg-3">
                    <label class="control-label">% de Retencion:</label>
                    <input type="text" class="form-control" name="porcentaje_de_retencion" id="porcentaje_de_retencion" value="3">
                </div>                
                <div class="col-xs-3 col-md-3 col-lg-3">
                    <label class="control-label">Total Retencion:</label>
                    <input type="text" class="form-control" name="total_retencion" id="total_retencion" value="<?php echo $comprobante['total_retencion'] ?>">
                </div>                
                </div>
            </div>
            ...
            <?php if ($configuracion->notas): ?>                
                <div class="panel panel-info" id="panel_otros">
                    ...
                    <div class="panel-body">
                        <textarea name="notas" id="notas" rows="3" cols="100" <?php if($comprobante['notas'] == ''):?> <?php endif?>><?php echo $comprobante['notas']?></textarea>
                    </div>
                </div>
            <?php endif ?>                
                <div class="panel panel-info" id="panel_otros">
                    ...
                    <div class="panel-body">
                        <textarea name="notas" id="notas" rows="3" cols="100" <?php if($comprobante['notas'] == ''):?> <?php endif?> style="width: 100%;"><?php echo $comprobante['notas']?></textarea>
                    </div>
                </div>        
        </div>        
                ...
                <div class="panel panel-body">
                    ...
                    <div class="input-group">        
                     ...
                     <div class="input-group">        
                        ...
                        <input type="text" id="total_icbper" name="total_icbper" class="form-control" value="<?PHP echo $comprobante['total_icbper']?>" readonly="" style="border:1px solid #ABB2B9;border-bottom:0;">
                    </div>
...
<div class="input-group" style="padding-bottom: 2rem;">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <input id="guardar" type="submit" class="btn btn-primary btn-lg btn-block" value="Actualizar Comprobante de Pago" style="background: #1ABC9C;border:0;" data-toggle='modal' data-target='#myModalPagoMonto' data-keyboard='false' data-backdrop='static'/>
            </div>
        </div>                    
    </div> 
</form>
...
<script type="text/javascript"> 
 ...
 //ALEXANDER FERNANDEZ 21/12/2021 - CÁLCULO DE DETRACCIÓN        
    detraccion();
    $('#detraccion').on('change',function(){
        detraccion();
    });

    //Retención ----- Alexander Fernández 13/04/22
  ...
  function detraccion(){
            if($('#detraccion').is(':checked')){
                $('#panelDetraccion :input:not(:checkbox)').prop('disabled',false);
                            
                var porcentaje_de_detraccion = $('#porcentaje_de_detraccion').val();
                    total = $('#total_a_pagar').val();
                    total_detraccion = total * (porcentaje_de_detraccion/100);                    
                    $('#total_detraccion').val(total_detraccion.toFixed(2));                
            } else {
                $('#panelDetraccion :input:not(:checkbox)').prop('disabled',true);
            }
    }

    function retencion(){
            if($('#retencion').is(':checked')){
                $('#panelRetencion :input:not(:checkbox)').prop('disabled',false);               
                var porcentaje_de_retencion = $('#porcentaje_de_retencion').val();
                    total = $('#total_a_pagar').val();
                    total_retencion = total * (porcentaje_de_retencion/100);                    
                    $('#total_retencion').val(total_retencion.toFixed(2));                
            } else {
                $('#panelRetencion :input:not(:checkbox)').prop('disabled',true);
            }
    }
    ...
    //CARGAR MODAL PAGO PAGO_MONTO 11-12-2020
    $("#guardar").on('click',function(e){      
        e.preventDefault();
        var action = 1;
        $("#myModalPagoMonto").load("<?= base_url()?>index.php/comprobantes/modal_pagoMonto",{action: action});
    });  
