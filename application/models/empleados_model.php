...
class Empleados_model extends CI_Model {
    ...
    public function login($usuario,$id,$almacen_id = '') {
        ...
        if ($id == 1) {
            $rsUsuario = $this->db->select('emp.id, emp.nombre, emp.dni, emp.apellido_paterno, emp.apellido_materno, emp.email, emp.tipo_empleado_id, temp.tipo_empleado,epr.empresa,epr.foto')
        ...
        if($rsUsuario)
        {
            ...
            $accesoEmpleado =  ($rsUsuario->tipo_empleado == 'VENDEDOR') ? 'style = "display:none"' : '';
