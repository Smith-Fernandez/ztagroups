    ...
    public function guardarProforma() {
     ...
     $mostrar_imagen = ($_POST['mostrar_imagen'] == 'on') ? 1 : 0;
        ...
        if($_POST['proformaId'] == '') {
            ...
            /*$dataInsert['prof_doc_serie'] = $_POST['serie'];
            $dataInsert['prof_doc_numero'] = $_POST['numero'];*/
           // $dataInsert['comp_doc_documento'] = $_POST['documento'];
            // guadamos para que muestre imagen
            ...
            $dataInsert['prof_condicion_pago'] = $_POST['condicion_pago'];
            $dataInsert['prof_plazo_entrega']  = $_POST['plazo_entrega'];
           ...
           /* $dataUpdate['prof_doc_serie'] = $_POST['serie'];
            $dataUpdate['prof_doc_numero'] = $_POST['numero'];*/
           // $dataUpdate['comp_doc_documento'] = $_POST['documento'];
            ...
            $dataUpdate['prof_condicion_pago'] = $_POST['condicion_pago'];
            $dataUpdate['prof_plazo_entrega']  = $_POST['plazo_entrega'];
              //actualizamos para que no muestre imagen
        ...
        for($i=0;$i<$cantidadIngresos;$i++)
        {
          $result = $this->db->from('productos')
            ...
            //echo $prod_descripcion;exit;
            $dataInsertDetalle = [
                                    
                                    "profd_descripcion" => $prod_descripcion,                                    
                                    "profd_unidad_id"   => $_POST['medida'][$i],
    ...
    public function getMainList() {
       ...
       if($_POST['cliente'] > 0)
        ...
        foreach($rsproformas as $proforma)
        {
            ...
            $proforma->btn_ticket = '<a href="'.base_url().'index.php/proformas/decargarPdf_ticket/'.$proforma->prof_id.'" target="_seld" ><img src="'.base_url().'/images/pdf.png" data-id="'.$proforma->prof_id.'" class="descargar-pdf"></a>';
            //boton editar
