...
class Salidas_model extends CI_Model
{
    ...
    public function guardarProductoSalida()
    {
        ...
        $stock = $this->productos_model->getStockProductos($_POST['producto'],$this->session->userdata("almacen_id"));
      ...
      $concepto = 'MOVIMIENTO DE ALMACEN SALIDA';
      $this->productos_model->salidaStock($_POST['producto'], $_POST['cantidad'], $concepto, $salidaId);
    ...
    public function eliminarDetalleSalida($idDetalle)
    {
      ...
      $concepto = 'MOVIMIENTO DE ALMACEN SALIDA - RESTAURAR';
      $this->productos_model->ingresarStock($rsDetalle->sald_producto_id,$rsDetalle->sald_cantidad, $concepto, $idDetalle);        
