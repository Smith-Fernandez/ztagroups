...
class Productos extends CI_Controller
{
   ...
   public function selectPrecioCodBarra() {
    ...
    public function agregarPresentacion($idProducto){        
        $data['producto'] = $this->productos_model->select($idProducto);        
    ...
    public function selectPresentacion(){
        ...
        //TRAE PRESENTACIONES
        $rsPresentaciones = $this->producto_presentaciones_model->selectPresentacion($idProducto);
        echo '<table class="table table-streap">';
        foreach ($rsPresentaciones as $value) {

            echo '<tr><td>'.$value->prod_nombre.'</td><td>'.$value->cantidad.'</td><td>'.$value->eliminar.'</td></tr>';            
        }
        echo '</table>';
    } 
